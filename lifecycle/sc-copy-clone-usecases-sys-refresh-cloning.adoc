...
https://www.netapp.com/pdf.html?item=/media/8584-tr4646pdf.pdf[SAP HANA Disaster Recovery with Storage Replication]

link:../backup/hana-dr-anf-data-protection-overview.html[SAP HANA disaster recovery with Azure NetApp Files]
