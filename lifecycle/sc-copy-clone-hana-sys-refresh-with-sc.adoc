...
as described in https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-br-scs-overview.html[TR-4614: SAP HANA Backup and Recovery with SnapCenter]
