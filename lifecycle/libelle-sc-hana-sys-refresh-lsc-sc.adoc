...
For more details regarding these different SnapCenter agents and SAP HANA database plug-in installation options, see the technical report link:../backup/hana-sc-generic-scope.html[TR-4614: SAP HANA backup and recovery with SnapCenter^].
