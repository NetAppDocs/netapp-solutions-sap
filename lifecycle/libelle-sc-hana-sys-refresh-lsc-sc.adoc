...
For more details regarding these different SnapCenter agents and SAP HANA database plug-in installation options, see the technical report link:../backup/hana-sc-generic-scope.html[SAP HANA backup and recovery with SnapCenter^].
...
* https://www.netapp.com/pdf.html?item=/media/12403-tr4700.pdf[SnapCenter Plug-In for Oracle Database^]
* link:../backup/hana-sc-generic-scope.html[SAP HANA Backup and Recovery with SnapCenter^]
* link:sc-copy-clone-introduction.html[Automating SAP HANA System Copy and Clone Operations with SnapCenter^]
