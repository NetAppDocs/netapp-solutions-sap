...
|Storage protocol and file system|Bare metal: NFS, FC with XFS
...
|Cloning from off-site backup |Yes |Yes |Yes, restore to new volume from ANF backup
|Cloning at DR site |Yes |Yes |Yes, but not integrated into SnapCenter
|===

Additional information on SAP system refresh operations for HANA with VMware VMFS and NetApp ASAr2 systems can be found at  https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-sc-vmfs-asar2sap-refresh.html[SAP System Refresh].