...
* link:../bp/hana-aff-fc-introduction.html[SAP HANA on NetApp All Flash FAS Systems with Fibre Channel Protocol]
* link:../bp/hana-aff-nfs-introduction.html[SAP HANA on NetApp All Flash FAS Systems with NFS]
* link:../backup/fsxn-overview.html[SAP HANA on Amazon FSx for NetApp ONTAP - Backup and recovery with SnapCenter]
* link:lama-ansible-introduction.html[NetApp SAP Landscape Management Integration using Ansible]
* link:libelle-sc-overview.html[Automating SAP system copy operations with Libelle SystemCopy (netapp.com)]
...
|Version 4.1 |February 2026 | Added required steps for HANA encryption and SAP local secure store LSS
|===
