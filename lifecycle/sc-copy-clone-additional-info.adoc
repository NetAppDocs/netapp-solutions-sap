...
* https://docs.netapp.com/us-en/netapp-solutions-sap/backup/fsxn-overview.html[TR-4926: SAP HANA on Amazon FSx for NetApp ONTAP - Backup and recovery with SnapCenter]
