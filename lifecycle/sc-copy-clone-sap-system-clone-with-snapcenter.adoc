...
image:sc-copy-clone-image41.png[A diagram of a system Description automatically generated,width=250,height=181]
...
image:sc-copy-clone-image43.png[Graphical user interface, application, Teams Description automatically generated,width=250,height=70]
...
image:sc-copy-clone-image45.png[Graphical user interface, text, application, Word Description automatically generated,width=272,height=342]
...
image:sc-copy-clone-image48.png[Graphical user interface, application Description automatically generated,width=281,height=77]
...
image:sc-copy-clone-image23.png[A screenshot of a computer Description automatically generated,width=281,height=115]

The job details screen in SnapCenter shows the progress of the operation.

image:sc-copy-clone-image49.png[Graphical user interface, application Description automatically generated,width=264,height=335]
