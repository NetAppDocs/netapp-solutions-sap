...
image:extracted-media/media\/sc-copy-clone-image41.png[A diagram of a system Description automatically generated,width=416,height=302]
...
image:extracted-media/media\/sc-copy-clone-image42.png[Background pattern Description automatically generated with medium confidence,width=624,height=158]
[start=2]
...
image:extracted-media/media\/sc-copy-clone-image43.png[Graphical user interface, application, Teams Description automatically generated,width=624,height=177]
...
image:extracted-media/media\/sc-copy-clone-image44.png[A screenshot of a computer Description automatically generated,width=576,height=280]

[start=4]
. The Job Details screen in SnapCenter shows the progress of the operation.

image:extracted-media/media\/sc-copy-clone-image45.png[Graphical user interface, text, application, Word Description automatically generated,width=453,height=570]
...
image:extracted-media/media\/sc-copy-clone-image46.png[Graphical user interface, application Description automatically generated,width=624,height=120]
...
image:extracted-media/media\/sc-copy-clone-image47.png[Graphical user interface, application, Teams Description automatically generated,width=624,height=169]

[start=2]
. Select the host where the target repair system has been prepared. The NFS export IP address must be the storage network interface of the target host. As target SID keep the same SID as the source system. In our example SS1

image:extracted-media/media\/sc-copy-clone-image48.png[Graphical user interface, application Description automatically generated,width=624,height=172]
...
image:extracted-media/media\/sc-copy-clone-image49.png[Graphical user interface, application Description automatically generated,width=377,height=479]
