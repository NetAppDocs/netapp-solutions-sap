...
NOTE: The HANA and Linux plug-ins are only available for the Intel CPU platform. For Linux on IBM Power a central HANA plug-in deployment needs to be setup as described in chapter Deployment options for SAP HANA plug-in.
