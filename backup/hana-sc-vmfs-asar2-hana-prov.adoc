...
To meet the storage performance KPIs set by SAP, dedicated LUNs and datastores must be configured for each filesystem of the HANA system. Datastores should not be shared among multiple HANA systems or other workloads.
...
192.168.175.86:/sapcc++_++share 1.4T 840G 586G 59% /mnt/sapcc-share
