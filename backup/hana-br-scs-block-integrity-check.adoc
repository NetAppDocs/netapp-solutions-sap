...
image:saphana-br-scs-image94.png["Figure showing input/output dialog or representing written content"]
...
image:saphana-br-scs-image95.png["Figure showing input/output dialog or representing written content"]
