...
image:extracted-media/media/sc-saphana-vmware-smas-image31.png[]

== Topology view

Within the topology view, SnapCenter shows the backups of both source and destination storage clusters.

image:extracted-media/media/sc-saphana-vmware-smas-image32.png[]

image:extracted-media/media/sc-saphana-vmware-smas-image33.png[]
...
image:extracted-media/media/sc-saphana-vmware-smas-image34.png[]
...
image:extracted-media/media/sc-saphana-vmware-smas-image35.png[]

The figure below shows the Snapshots of the HANA data volume at the A800 cluster.

image:extracted-media/media/sc-saphana-vmware-smas-image36.png[]
