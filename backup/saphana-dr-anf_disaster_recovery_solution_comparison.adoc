...
More details on the different configuration options are provided in chapter link:saphana-dr-anf_anf_cross-region_replication_with_sap_hana_overview.html[Configuration options for cross region replication with SAP HANA].
