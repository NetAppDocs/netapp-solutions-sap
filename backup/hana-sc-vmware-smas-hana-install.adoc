...
A more detailed description can be found at https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-br-scs-resource-config-hana-database-backups.html#sap-hana-backup-user-and-hdbuserstore-configuration[SnapCenter resource-specific configuration for SAP HANA database backups]
