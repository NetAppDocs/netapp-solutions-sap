...
A more detailed description can be found at link:hana-sc-generic-sc-resource-config.html#sap-hana-backup-user-and-sap-hana-user-store-configuration[SnapCenter resource-specific configuration for SAP HANA database backups]
