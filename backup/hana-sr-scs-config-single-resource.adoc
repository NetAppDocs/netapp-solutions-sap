...
You can find more information about SAP HANA plug-in deployment options and user store configuration in the technical report TR-4614: link:hana-sc-generic-scope.html[SAP HANA Backup and Recovery with SnapCenter^].
