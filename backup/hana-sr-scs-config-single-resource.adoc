...
You can find more information about SAP HANA plug-in deployment options and user store configuration in link:hana-sc-generic-scope.html[SAP HANA Backup and Recovery with SnapCenter^].
