...
[.lead]
Restore and recover SAP HANA MDC systems using SnapCenter with automated or manual recovery options. This procedure includes complete system restores, single tenant restores, and volume-based or file-based restore operations for databases on ONTAP, Azure NetApp Files, and FSx for ONTAP.
