...
The setup and configuration of the on-premises SAP HANA backup and recovery solution is described in https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-br-scs-overview.html#the-netapp-solution[TR-4614: SAP HANA backup and recovery with SnapCenter (netapp.com)].
...
Prerequisite is that the SAP HANA backup configuration has been configured at NetApp Snap Center. For setting up Snap Center for SAP HANA in the first place refer to https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-br-scs-snapcenter-config.html[SnapCenter configuration (netapp.com)].
