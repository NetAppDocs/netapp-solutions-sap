...
The parameter must be set as described in chapter link:hana-sc-vmfs-asar2-hana-prov.html[“VM parameter disk.EnableUUID”], otherwise SnapCenter database auto discovery will fail.
