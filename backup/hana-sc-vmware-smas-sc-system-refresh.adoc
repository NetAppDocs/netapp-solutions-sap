...
Detailed information on the system refresh workflows can be found at: link:../lifecycle/sc-copy-clone-introduction.html[Automating SAP HANA System Copy and Clone Operations with SnapCenter]
