...
More details on the different configuration options are provided in chapter link:hana-dr-anf-cross-region-replication_overview.html[Configuration options for cross region replication with SAP HANA].
