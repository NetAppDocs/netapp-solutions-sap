...
image:saphana_aff_fc_image18.jpeg["Figure showing input/output dialog or representing written content"]

. Confirm that storage is successfully provisioned.

image:saphana_aff_fc_image19.jpeg["Figure showing input/output dialog or representing written content"]
