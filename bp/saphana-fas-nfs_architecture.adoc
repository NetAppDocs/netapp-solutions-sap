...
image:saphana-fas-nfs_image3.jpg["Figure showing input/output dialog or representing written content"]
...
For detailed information about the SAP HANA backup and recovery solution using SnapCenter, see https://docs.netapp.com/us-en/netapp-solutions-sap/backup/saphana-br-scs-overview.html[TR-4614: SAP HANA Backup and Recovery with SnapCenter^].
