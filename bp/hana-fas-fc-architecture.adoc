...
For detailed information about the SAP HANA backup and recovery solution using SnapCenter, see link:../backup/hana-sc-generic-scope.html[TR-4614: SAP HANA Backup and Recovery with SnapCenter^].
