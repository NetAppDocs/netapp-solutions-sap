...
For detailed information about the SAP HANA backup and recovery solution using SnapCenter, see link:../backup/hana-sc-generic-scope.html[SAP HANA Backup and Recovery with SnapCenter^].
