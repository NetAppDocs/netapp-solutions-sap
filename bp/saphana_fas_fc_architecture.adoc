...
image::saphana_fas_fc_image2.png[]
...
image::saphana_fas_fc_image3.png[]
...
image::saphana_fas_fc_image4.png[]
...
image::saphana_fas_fc_image5.jpg[]
...
For detailed information about the SAP HANA disaster recovery solution using SnapCenter, see https://docs.netapp.com/us-en/netapp-solutions-sap/backup/saphana-dr-sr_pdf_link.html[TR-4646: SAP HANA Disaster Recovery with Storage Replication^].
...
image::saphana_fas_fc_image6.png[]
...
image::saphana_fas_fc_image7.png[]
