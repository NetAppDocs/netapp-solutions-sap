...
lun create -path /vol/FC5_shared/FC5-lss_shared -size 60g -ostype linux -space-reserve disabled -space-allocation disabled -class regular
....
...
lun map -path /vol/FC5_shared/FC5-lss_shared -igroup HANA-FC5
....