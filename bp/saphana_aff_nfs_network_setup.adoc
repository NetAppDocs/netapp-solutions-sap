...
image:saphana_aff_nfs_image10.png["Figure showing input/output dialog or representing written content"]
...
image:saphana_aff_nfs_image11.png["Figure showing input/output dialog or representing written content"]
