...
image:saphana_aff_nfs_image2.png["Figure showing input/output dialog or representing written content"]

The following figure shows an example of using VMware vSphere as a virtualization layer.

image:saphana_aff_nfs_image3.jpg["Figure showing input/output dialog or representing written content"]
...
image:saphana_aff_nfs_image4.png["Figure showing input/output dialog or representing written content"]
...
image:saphana_aff_nfs_image5.png["Figure showing input/output dialog or representing written content"]
