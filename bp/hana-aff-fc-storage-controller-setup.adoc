...
. Create and configure volumes and LUNs within the aggregates as described in the section  link:hana-aff-fc-host-setup_single_host.html[Single Host Setup] for single hosts 
or in section link:hana-aff-fc-host-setup_multiple_hosts.html[Multiple Host Setup]
