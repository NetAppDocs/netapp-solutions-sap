...
For detailed information about SAP HANA disaster recovery solutions, see  https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-dr-sr-pdf-link.html[TR-4646: SAP HANA Disaster Recovery with Storage Replication^].
