...
image:saphana-fas-nfs_image2.png["Figure showing input/output dialog or representing written content"]
...
image:saphana-fas-nfs_image4.png["Figure showing input/output dialog or representing written content"]
...
image:saphana-fas-nfs_image5.png["Figure showing input/output dialog or representing written content"]
...
image:saphana-fas-nfs_image6.jpg["Figure showing input/output dialog or representing written content"]
...
For detailed information about the SAP HANA backup and recovery solution using SnapCenter, see https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-br-scs-overview.html[TR-4614: SAP HANA Backup and Recovery with SnapCenter^].
...
For detailed information about the SAP HANA disaster recovery solutions, see https://docs.netapp.com/us-en/netapp-solutions-sap/backup/hana-dr-sr-pdf-link.html[TR-4646: SAP HANA Disaster Recovery with Storage Replication^].
