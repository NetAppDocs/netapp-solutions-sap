...
* FAS2750, FAS2820, FAS8300, FAS8700, and FAS9500. A complete list of NetApp certified storage solutions for SAP HANA can be found at the https://www.sap.com/dmc/exp/2014-09-02-hana-hardware/enEN/#/solutions?filters=v:deCertified;ve:13[Certified and Supported SAP HANA Hardware Directory^].
...
image::saphana-fas-nfs_image1.png[]
