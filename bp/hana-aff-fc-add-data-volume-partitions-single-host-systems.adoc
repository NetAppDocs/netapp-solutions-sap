...
. Configure multipathing for the additional LUNs, as described in chapter link:hana-aff-fc-host-setup.html[Host Setup].
...
image:saphana_aff_fc_image20.png["Figure showing input/output dialog or representing written content"]
