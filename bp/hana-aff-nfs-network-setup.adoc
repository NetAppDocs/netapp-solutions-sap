...
[NOTE]
Depending on the number of SAP HANA hosts and the connection speed used, different numbers of active physical ports are needed. For details, see the section link:hana-aff-nfs-storage-controller-setup.adoc.html#lif-configuration["LIF configuration"].
...
image:saphana_aff_nfs_image11a.png["VMware specific Network Settup"]
