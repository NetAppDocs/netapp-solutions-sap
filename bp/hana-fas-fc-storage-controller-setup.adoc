---
sidebar: sidebar
permalink: bp/hana-fas-fc-storage-controller-setup.adoc.html
...
[NOTE]
The `sanlun` tool is part of the NetApp Host Utilities and must be installed on each SAP HANA host. More details can be found in section link:hana-fas-fc-host-setup.adoc.html[Host setup.]
