---
sidebar: sidebar
permalink: bp/hana-fas-nfs-add-data-volume-partitions.adoc.html
...
In addition to the tasks described in the section link:hana-fas-nfs-host-setup.adoc.html[“Host setup,”] you must create the additional mount points and fstab entries for the new additional data volume(s), and you must mount the new volumes.
