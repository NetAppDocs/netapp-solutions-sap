...
[.lead]
The NetApp AFF A-Series product family has been certified for use with SAP HANA in tailored data center integration (TDI) projects. This guide provides best practices for SAP HANA on this platform for NFS.
