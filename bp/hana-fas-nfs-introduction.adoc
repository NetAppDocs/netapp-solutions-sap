...
* https://docs.netapp.com/us-en/netapp-solutions-sap/bp/hana-fas-fc-introduction.html[SAP HANA on NetApp FAS Systems with Fibre Channel Protocol^]
* https://docs.netapp.com/us-en/netapp-solutions-sap/bp/hana-aff-nfs-introduction.html[SAP HANA on NetApp AFF Systems with NFS^]
