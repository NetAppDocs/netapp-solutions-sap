...
[NOTE]
SAP HANA multiple-host systems require the `/hana/shared` and `/lss/shared` file systems connected to all hosts of a system. Usually this is a NFS share provided by by an NFS server. 
